...
Route::group(['middleware'=>['auth'] ],function(){
    ...
    Route::get('/rpt-se-tv-regional/{id}','RptSETvNacionalController@index')->name('consulta-se-tv-regional');
    Route::get('/rpt-se-md-nacional/{id}',' RptSETvNacionalController@index')->name('consulta-se-md-nacional');
    Route::get('/rpt-se-md-nacional/{id}','RptSETvNacionalController@index')->name('consulta-se-md-nacional');
